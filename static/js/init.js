...
function arlo_tm_modalbox() {
  "use strict";
  jQuery(".arlo_tm_all_wrap").prepend(
    '<div class="arlo_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>'
  );
}
...
function arlo_tm_modalbox_news() {
  ...
  var modalBox = jQuery(".arlo_tm_modalbox");
  var button = jQuery(
    ".arlo_tm_news .arlo_tm_full_link,.arlo_tm_news .news_list .title a"
  );
  var closePopup = modalBox.find(".close");
  button.on("click", function () {
    var element = jQuery(this);
...
function arlo_tm_modalbox_portfolio() {
  ...
  button.on("click", function () {
    ...
    modalBox
      ...
      .after('<div class="portfolio_main_title">' + info + "</div>");
    arlo_tm_data_images();
    return false;
  });
}
...
function arlo_tm_scrollable() {
  ...
  scrollable.each(function () {
    var element = jQuery(this);
    element
      .css({ height: H - logoHeight - copyrightHeight })
      .niceScroll({
        touchbehavior: false,
        cursorwidth: 0,
        autohidemode: true,
...
function recallJarallax() {
  ...
  jQuery(".jarallax").each(function () {
    ...
    element.jarallax("destroy").jarallax({ speed: customSpeed });
  });
}
